...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo base_url('AdminLTE-3.2.0/') ?>dist/css/adminlte.min.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url('AdminLTE-3.2.0/') ?>plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo base_url('sbadmin/')?>img/undraw_profile.svg">
                            </a>
